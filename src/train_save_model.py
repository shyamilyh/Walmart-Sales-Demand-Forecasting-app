# -*- coding: utf-8 -*-
"""src/train_save_model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LtmR72UPgAksg1EaIbU-jZB3N74GA4fs
"""
...
def main():
    ...
    meta = {
        "stores": sorted([int(s) for s in df['store'].unique()])[:200],   # avoid too long lists
        "depts": sorted([int(d) for d in df['dept'].unique()])[:200],
        "types": sorted([int(t) for t in df['type'].unique().tolist()]) if 'type' in df else ["A","B","C"], # Convert to list before sorting
